...
;(function($){
	$(function(){
		...
		$('#homeSlider')
			.mouseenter(function(){ $(this).find('ul.flex-direction-nav').stop(true, true).fadeIn(500)})
			.mouseleave(function(){ $(this).find('ul.flex-direction-nav').stop(true, true).fadeOut(500)})
	...
	$(window).load(function(){
		// home slider
		if ( $('#homeSlider').length == 0 ) return false
		$('div#homeSlider').flexslider({
			animation: "slide",
			slideshow: true,
			directionNav: true,
			controlNav: true,
